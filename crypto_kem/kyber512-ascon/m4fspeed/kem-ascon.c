                                     ...
                                     const uint8_t *coins)
{
    ...
    hash_ascon_a(sk + KYBER_SECRETKEYBYTES - 2 * KYBER_SYMBYTES, pk, KYBER_PUBLICKEYBYTES);
                                 ...
                                 const uint8_t *coins)
{
    ...
    hash_ascon_a(buf + KYBER_SYMBYTES, pk, KYBER_PUBLICKEYBYTES);
    hash_ascon_a(kr, buf, 2 * KYBER_SYMBYTES);
